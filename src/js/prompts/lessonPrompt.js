...
- 英語の場合、outを「アウトゥ」と固定しないでください。「アウ（tを短く）」や「アウッ（最後を短く）」のように括弧で説明してください。
- 「アウt」「グッd」「ジャスt」のように、カタカナと英字を直接混ぜた補助表記は禁止です。必要なら「アウ（tを短く）」のように括弧で説明してください。
...
- readingGuideの「原文:」「補助:」「注意:」は必ず改行区切りにしてください。1行に詰め込まないでください。

readingGuideの例:
原文: I'm / just / heading / out
補助: アイム / **ジャスト** / ヘディン(グ) / **アウ（tを短く）**
